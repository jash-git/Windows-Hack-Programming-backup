========================================================================
    动态链接库：DllHijack2_Test 项目概述
========================================================================

应用程序向导已为您创建了此 DllHijack2_Test DLL。

本文件概要介绍组成 DllHijack2_Test 应用程序的每个文件的内容。
...
StdAfx.h, StdAfx.cpp
    这些文件用于生成名为 DllHijack2_Test.pch 的预编译头 (PCH) 文件和名为 StdAfx.obj 的预编译类型文件。
